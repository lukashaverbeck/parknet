...
class SensorManager:
    ...
    def get_distance(self, direction):
        """ gives the latest measured distance in a certain direction
            ...
            Args:
                direction (int): integer representing the direction of the measured distance (0 - 3)
        ...
        elif direction == const.Direction.BACK_ANGLED:
            return self.__distance_back_angled
        else:
            return None
